...
map<ScriptOperation, pair<int, int>> Script::opArgCounts = {
		...
		{S_VECTOR_GET_Y,                {1, 1}},
		{S_VECTOR_GET_Z,                {1, 1}},
		{S_MATRIX_CONSTRUCT,            {0, -1}},
		{S_MATRIX_X_QUERY,              {1, 1}},
		{S_MATRIX_Y_QUERY,              {1, 1}},
		{S_MATRIX_EXTRACT,              {1, 2}},
		{S_MATRIX_IDENTITY_GENERATOR,   {1, 1}},
		{S_MATRIX_ADDITION,             {2, -1}},
		{S_MATRIX_SUBTRACTION,          {2, -1}},
		{S_MATRIX_MULTIPLICATION,       {2, -1}},
		{S_MATRIX_DETERMINANT,          {1, 1}},
		{S_ARRAY_CONSTRUCT,             {0, -1}},
		{S_ARRAY_EXTRACT,               {2, 2}},
		{S_ARRAY_LENGTH_QUERY,          {1, 1}},
		{S_ARRAY_PREPEND,               {2, -1}},
		{S_ARRAY_APPEND,                {2, -1}},
		{S_ARRAY_DELETE,                {2, 3}},
		{S_PRINT,                       {1, -1}},
...
map<ScriptOperation, OperationType> Script::opTypes = {
		...
		{S_MATRIX_CONSTRUCT,            STRING_SCR},
		{S_MATRIX_X_QUERY,              MATRIX_SCR},
		{S_MATRIX_Y_QUERY,              MATRIX_SCR},
		{S_MATRIX_EXTRACT,              MATRIX_SCR},
		{S_MATRIX_IDENTITY_GENERATOR,   INTEGER_SCR},
		{S_MATRIX_ADDITION,             MATRIX_SCR},
		{S_MATRIX_SUBTRACTION,          MATRIX_SCR},
		{S_MATRIX_MULTIPLICATION,       MATRIX_SCR},
		{S_MATRIX_DETERMINANT,          MATRIX_SCR},
		{S_ARRAY_CONSTRUCT,             STRING_SCR},
		{S_ARRAY_EXTRACT,               STRING_SCR},
		{S_ARRAY_LENGTH_QUERY,          ARRAY_SCR},
		{S_ARRAY_PREPEND,               STRING_SCR},
		{S_ARRAY_APPEND,                STRING_SCR},
		{S_ARRAY_DELETE,                STRING_SCR},
		{S_FLOOR,                       REAL_SCR},
		{S_CEIL,                        REAL_SCR},
		{S_ROUND,                       REAL_SCR},
		{S_DROUND,                      REAL_SCR},
